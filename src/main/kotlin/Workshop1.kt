...
fun main() {
    ...
    while (true) {
        ...
        when (choice) {
            ...
            "exit" -> {
                println("ออกจากโปรแกรม โชคดีมีชัยโชคชัยมีวัว!")
                break
            }
            else -> println("ตัวเลือกไม่ถูกต้อง: กรุณาเลือก 1, 2 หรือพิมพ์ exit เพื่อออกจากโปรแกรม")
        }
...
fun convertCelsiusToFahrenheit() {
    ...
    val celsius = input.toDoubleOrNull() ?: run {
        println("ข้อผิดพลาด: กรุณาป้อนข้อมูลเป็นตัวเลขเท่านั้น")
        return
    }
